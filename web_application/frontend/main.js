...
// ... для сторінки "Клієнти"
exp.get("/clients", (req, res) => {
  res.render("pages/clients", { title: "Клієнти",
                                 use_db: USE_DB,
                                 server_port: SERVER_PORT,
                                 add_button: "Додати нового клієнта",
                                 page_id: "3" });
});
